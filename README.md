...
The AI Assistant is disabled by default in Docker. To enable it, set `AI_ENABLED=true` and provide your own OpenAI-compatible endpoint:
...
|----------|-------------|---------|
| `AI_ENABLED` | Enable the AI assistant | `false` |
