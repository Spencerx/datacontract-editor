    ...
    useEffect(() => {
        ...
        if (encodedData) {
            try {
                ...
                alert(t('app.error.loadShareFailed'));
            }
        }
    }, [setYaml]);
                    ...
                    <div className="bg-red-50 border border-red-200 rounded-lg p-6 max-w-lg">
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                                <h1 className="text-lg font-bold text-red-800">{t('app.error.title')}</h1>
                                <p className="mt-2 text-sm text-red-700">
                                    {t('app.error.description')}
                                </p>
                                <div className="mt-3 text-sm text-red-600">
                                    <span className="font-medium">{t('app.error.errorLabel')}</span>
                                    {error?.message || t('app.error.unknown')}
                                </div>
