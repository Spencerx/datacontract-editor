							...
							<svg className="h-8 w-auto" viewBox="0 0 530 587" xmlns="http://www.w3.org/2000/svg"
								...
								<defs>
									<linearGradient id="_Linear1" x1="0" y1="0" x2="1" y2="0" gradientUnits="userSpaceOnUse"
										...
										<stop offset="0" style={{stopColor: "rgb(134,25,143)", stopOpacity: 1}}/>
										<stop offset="1" style={{stopColor: "rgb(134,25,143)", stopOpacity: 1}}/>
									</linearGradient>
									<linearGradient id="_Linear2" x1="0" y1="0" x2="1" y2="0" gradientUnits="userSpaceOnUse"
																	gradientTransform="matrix(3.12309e-14,-510.04,510.04,3.12309e-14,264.9,586.54)">
										<stop offset="0" style={{stopColor: "rgb(192,38,211)", stopOpacity: 1}}/>
										<stop offset="1" style={{stopColor: "rgb(217,70,239)", stopOpacity: 1}}/>
									</linearGradient>
									<linearGradient id="_Linear3" x1="0" y1="0" x2="1" y2="0" gradientUnits="userSpaceOnUse"
										...
										<stop offset="0.39" style={{stopColor: "rgb(229,112,247)", stopOpacity: 1}}/>
										<stop offset="1" style={{stopColor: "rgb(232,121,249)", stopOpacity: 1}}/>
									</linearGradient>
								</defs>
							</svg>
                          ...
                          <div className="size-4">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                              <path fillRule="evenodd"
												...
												<span
													className="lg:ml-1.5 inline-flex items-center rounded-full px-1.5 py-[1.5px] text-[0.6rem] font-medium bg-red-100 text-red-700">
                          {totalCount}
                        </span>
											)}
                    </span>
